...
Revision ID: 6af4fe982bf6
Revises: 
Create Date: 2020-12-14 23:32:22.821004
...
def upgrade():
    ...
    sa.Column('equipment_description', sa.String(), nullable=False),
    sa.Column('category', sa.String(), nullable=False),
    sa.Column('rented', sa.Boolean(), nullable=True),
    sa.Column('rentpw', sa.Integer(), nullable=False),
    sa.Column('owner_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['owner_id'], ['profiles.profileid'], ),
    sa.PrimaryKeyConstraint('id'),
